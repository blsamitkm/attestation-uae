...
<header class="header header-sticky">
	<div class="header-top">
		<div class="container">
			...
			<h5> BLS Document Delivery Services for UAE - Kuwait<!--span><img src="assets/images/azerbaijan.svg" alt="Azerbaijan flag" width="40" /></span--></h5>
...
<?php } elseif ($page == 'consignment.php') { ?>
	<div class="inner_banner">
		<span><img src="assets/images/page-title.jpg" alt="" /> </span>
		<div class="banner_inner_content">
			<div class="container">
				...
				<ul class="bread-crumb">
					<li><a href="./">Home</a></li>
					<li>Consignment Track Application</li>
				</ul>
			</div>
		</div>
	</div>
