...
<html lang="en">
	<head>
		...
		<meta name="keywords" content="Track Application">
		<meta name="description" content="Track Application">
		...
		<?php include 'header.php' ?>
			<div class="inner_page">
				<div class="container">
					...
					<p class="mb-2">If you have already submitted your application, you can track it online using our tracking service.</p>
					<iframe src="https://attestation-uae.blsinternational.com/software/search" width="100%" height="605px"></iframe>
				</div>
			</div>
